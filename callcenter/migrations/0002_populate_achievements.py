...
def populate_achievements(apps, schema_editor):
    ...
    with open('callcenter/migrations/0002_populate_achievements.tsv', 'r', encoding='utf-8') as f:
...
def truncate_achievements(apps, schema_editor):
    Achievement = apps.get_model('callcenter', 'Achievement')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(populate_achievements, truncate_achievements)
    ]
